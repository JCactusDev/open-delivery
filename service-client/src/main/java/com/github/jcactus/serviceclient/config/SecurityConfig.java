package com.github.jcactus.serviceclient.config;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/clients").hasAuthority("SCOPE_clients.update")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/clients").hasAuthority("SCOPE_clients.update")
