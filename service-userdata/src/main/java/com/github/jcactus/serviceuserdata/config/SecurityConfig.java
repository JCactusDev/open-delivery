    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/users").hasAuthority("SCOPE_users.update")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/users").hasAuthority("SCOPE_users.update")
