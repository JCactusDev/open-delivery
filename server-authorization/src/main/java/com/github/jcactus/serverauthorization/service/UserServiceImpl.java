package com.github.jcactus.serverauthorization.service;
...
import com.github.jcactus.serverauthorization.model.User;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ServiceInstance serviceInstance = discoveryClient.getInstances("service-userdata").get(0);
