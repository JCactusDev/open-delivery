    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/orders/{id}").hasAuthority("SCOPE_orders.update")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/orders/{id}").hasAuthority("SCOPE_orders.update")
